...
O seu objetivo é criar uma página web que exibe uma lista de municípios de um estado, de acordo com a seleção do usuário.  
Todos os dados devem ser buscados da API do IBGE.

## O que fazer?

**Construa a Interface:**  
Crie uma página simples em HTML e CSS com dois elementos principais:
...
**Entrega:**  
A entrega deve ser feita através de uma Release no GitHub.  
Envie o arquivo ZIP da release e o link do seu repositório pessoal no Google Classroom.
